/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: 38595ded0b69cf970818ff5a773b35b3)
// Runtime types generated with workerd@1.20250428.0 2025-04-01 global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		NEXT_INC_CACHE_KV: KVNamespace;
		EMAIL_FROM: "mathewlewallen@gmail.com";
		EMAIL_FROM_NAME: "Open Cloud Map";
		EMAIL_REPLY_TO: "support@opencloudmap.com";
		NEXTJS_ENV: string;
