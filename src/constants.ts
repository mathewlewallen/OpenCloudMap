...
export const SITE_NAME = "Open Cloud Map"
export const SITE_DESCRIPTION = "A modern Map for the Open Web built with Next.js 15, React 19, OpenNextJS, and Cloudflare."
export const SITE_URL = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://opencloudmap.com"
export const GITHUB_REPO_URL = "https://github.com/mathewlewallen/opencloudmap"
