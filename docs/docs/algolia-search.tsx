...
export default function AlgoliaSearch(props: AlgoliaProps) {
  return (
    <div className="relative border rounded-lg sm:w-fit w-[68%]">
      <div className="absolute right-2 top-[0.4rem] hidden items-center gap-0.5 text-xs font-mono sm:flex pointer-events-none">
      ...
      <div className="absolute top-[0.42rem] left-24 text-muted-foreground font-mono -tracking-[0.1rem] text-sm pl-[0.081rem] pointer-events-none">
        ...
      </div>
    </div>
  );
