...
import EditMember from "@/app/(auth)/dashboard/members/components/edit/EditMember";
				...
				return (
					...
					>
						...
						<div>
							<span
								className={cn(
									" dark:bg-zinc-800 px-2 py-1 rounded-full shadow-sm capitalize  border-[.5px] text-sm",
									{
